...
import me.odb.fakegps.R;
import me.odb.fakegps.data.DbHelper;
    ...
    private void search(final String key, EditText searchText) {
        if(key.startsWith("@"))
        {
            ...
            try {
                ...
                String[] keyList = {"自定义经纬度:" + key.substring(1)};
                new AlertDialog.Builder(AMapActivity.this)
                        ...
                        .setSingleChoiceItems(keyList, 0, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                markerOptions.draggable(true);
                                markerOptions.title("经度：" + latLng2.longitude
                                        + ",纬度：" + latLng2.latitude
                                                + ",精度：" + accuracy
                                );
                                aMap.addMarker(markerOptions);
